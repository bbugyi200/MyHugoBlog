...
* Made several improvements to the original source code of the `MakeBox` function in response to advice given by **statox42** in [this][vim-reddit] Reddit discussion.
